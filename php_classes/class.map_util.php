...
public static function calculate_area_from_envelope_wkt($envelope){
    ...
    $lat2 = $points[1][1];
    $lng2 = $points[1][0];
    $distance1 = Map_Utility::vincenty_great_circle_distance($lat1,$lng1,$lat2,$lng2);

    $lat1 = $points[1][1];
    $lng1 = $points[1][0];
    $lat2 = $points[2][1];
    $lng2 = $points[2][0];
    $distance2 = Map_Utility::vincenty_great_circle_distance($lat1,$lng1,$lat2,$lng2);

    $lat1 = $points[3][1];
    $lng1 = $points[3][0];
    $lat2 = $points[4][1];
    $lng2 = $points[4][0];
    $distance4 = Map_Utility::vincenty_great_circle_distance($lat1,$lng1,$lat2,$lng2);
...
*/
public static function calculate_centroid_json_2_wkt($json){
...
*/
public static function calculate_envelope_json_2_wkt($json){
	$mJson = geoPHP::load($json, "json");
 ...
 */
public static function vincenty_great_circle_distance(
